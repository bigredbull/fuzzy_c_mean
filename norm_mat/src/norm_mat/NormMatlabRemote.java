...
/**
 * The <code>NormMatlabRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  D:\\Java\\MyWorkspace\\test\\calNorms.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>NormMatlabRemote</code> 
 ...
 * generate RMI server proxy objects for instances of norm_mat.NormMatlab.
 */
public interface NormMatlabRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>calNorms</code> M-function 
     ...
     */
    public Object[] calNorms(int nargout, Object... rhs) throws RemoteException;
